...
\begin{table}[!ht]
  ...
  \begin{tabular}{@{}lc@{}}
    ...
    Number of time steps           & 120,000                   \\ \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!ht]
  \vrule depth12pt width 0pt
  \caption{Type B site information}
  \label{tab:vs30-2}
  ...
  \begin{threeparttable}
    ...
    \resizebox{\textwidth}{!}{%
      ...
      \begin{tabular}{@{}ccccccccc@{}}
        \toprule
        \multirow{2}{*}{Model}                    & \multicolumn{4}{c}{Type A sites} & \multicolumn{4}{c}{Type B sites}                                                                       \\ \cmidrule(l){2-9}
                                                  &
        East-west                                 &
        North-south                               &
        Vertical                                  &
