  ...
  \begin{threeparttable}
    ...
    \resizebox{\textwidth}{!}{%
      ...
      \begin{tabular}{@{}cccccc@{}}
        ...
        9        & No         & $Q_S=0.1V_Sf^{0.6}$               & No                     & 0                             & 500                 \\
        10       & No         & $Q_S=0.1V_S$                      & No                     & 0                             & 500                 \\
        11       & No         & $Q_S=0.1V_S$                      & No                     & 0                             & 200                 \\ \bottomrule
        \\[-5mm]
      \end{tabular}%
    }
    \begin{tablenotes}
      \item[\textsuperscript{*}] \footnotesize $Q_P=2Q_S$\\[-10pt]
      \item[\textdagger] \footnotesize Hurst number = 0.05; Horizontal to vertical correlation length ratio = 5
    \end{tablenotes}
  \end{threeparttable}
\end{table}
\clearpage
