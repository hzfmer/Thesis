...
\begin{figure}[!ht]
  ...
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S3c.pdf}\label{fig:etf-A3c}} \hfil
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S3d.pdf}\label{fig:etf-A3d}} \\[\baselineskip]%
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S3e.pdf}\label{fig:etf-A3e}} \hfil
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S3f.pdf}\label{fig:etf-A3f}} \\[\baselineskip]%
...
\begin{figure}[!ht]
  ...
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S4c.pdf}\label{fig:etf-A4c}} \hfil
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S4d.pdf}\label{fig:etf-A4d}} \\[\baselineskip]%
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S4e.pdf}\label{fig:etf-A4e}} \hfil
  \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/figure_etf_S4f.pdf}\label{fig:etf-A4f}} \\[\baselineskip]%
...
% The form of the Von K\'arm\'an autocorrelation function \citep{frankel_finite_1986} is
