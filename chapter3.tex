...
The GOF scores for the models (see \cref{tab:highf-2}) explored in this study are shown in \Cref{fig:highf-S7}, see also \Cref{fig:highf-12} and \Crefrange{fig:highf-S11}{fig:highf-S32} in \Cref{highf:app} for results for individual models. 
...
\begin{figure}[!ht]
  ...
  \caption{
  GOF scores for a subset of the metrics used in this study, for frequency band of 0.15-1 Hz, 1-2.5 Hz, and 2.5-5 Hz. Model IDs are listed in \Cref{tab:highf-2}.} 
